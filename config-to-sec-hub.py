...
def lambda_handler(event, context):
    ...
    if compliance_type == 'NON_COMPLIANT':
        ...
        findings = [{
            ...
            "Title": f"Unapproved Instance Type used for instance {resource_id}",
            "Description": "This instance is running with an Instance Typethat is not approved for use.",
            "ProductArn":f"arn:aws:securityhub:{region}:{account_id}:product/{account_id}/default",
            "AwsAccountId": account_id,
            "Id": f"unapproved-instance-type/{resource_id}",
            "GeneratorId": "CUSTOM:UnapprovedInstanceTypes",
            "Types": [],
    ...
    # if compliant and a finding exists then archive it
        ...
        filters = {
            ...
            "Id": [{
                "Value": f"unapproved-instance-types/{resource_id}",
                "Comparison": "EQUALS"
            }],
            "RecordState": [{
                "Value": "ACTIVE",
